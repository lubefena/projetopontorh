...
@Entity
@Table(name = "lancamento") //Nome da tabela no Banco de Dados
public class Lancamento implements Serializable { //Classe que terá uma tabela representada no Banco de Dados e que será propriedade da classe LancamentoBean.
	...
	@Temporal(TemporalType.DATE) //O uso do "Temporal.Type.DATE" garantirá o armazenamento apenas da Data no Banco de Dados.
	private Date data;
	
	private String descricao;
	
	@Column(precision = 10, scale = 2) //O uso do "precision = 10, scale = 2" garantirá o armazenamento no campo de números contendo 10 dígitos e 2 casas decimais no Banco de Dados.
